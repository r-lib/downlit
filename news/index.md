...
- [`highlight()`](https://downlit.r-lib.org/reference/highlight.md) no
  longer errors if a package imputed to have been attached isn’t
  installed.
...
- [`href_package()`](https://downlit.r-lib.org/reference/href_topic.md)
  is now exported
