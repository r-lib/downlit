...
[`evaluate::evaluate()`](https://downlit.r-lib.org/reference/evaluate.r-lib.org/reference/evaluate.md).
It syntax higlights code with
[`highlight()`](https://downlit.r-lib.org/reference/highlight.md), and
